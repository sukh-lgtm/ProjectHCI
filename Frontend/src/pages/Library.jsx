...
function Library({ selectionMode }) {
    ...
    return (
        ...
        {
            loading ?
                <div role="status" className="flex flex-row w-screen h-screen justify-center align-middle items-center overflow-x-hidden">
                    ...
                    <span className="font-bold ml-4 text-neutral-300">Loading Images</span>
                </div> :
