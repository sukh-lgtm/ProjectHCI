...
function RecentlyDeleted({ selectionMode, setSelectionMode }) {
    ...
    const [deletedImagesLength, setDeletedImagesLength] = useState(deletedImages.length);

    useEffect(() => {
        // Update the deletedImagesLength state whenever the images array changes
        setDeletedImagesLength(deletedImages.length);
    }, [deletedImages]);
