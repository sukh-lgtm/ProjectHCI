...
function MyListings() {
    ...
    async function setImageListing() {
        const currImageListings = (await axios.get('https://localhost:3000/getListings')).data
        const imageList = []
        for (const image in currImageListings) {
            imageList.push(image)
        }
        console.log(imageList)
        const imagesSourceUrls = (await axios.post('https://localhost:3000/getImageUrls', {imageList})).data
    ...
    function handleDeleteListing() {
        ...
        axios.post('https://localhost:3000/deleteListing', obj).then(() => {
